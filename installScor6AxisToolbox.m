...
%
%   INSTALLSCOR6AXISTOOLBOX(true) installs the ScorBot 6-Axis Toolbox 
%   regardless of whether a copy of the Scor6Axis toolbox exists in the 
%   MATLAB root.
%
%   INSTALLSCOR6AXISTOOLBOX(false) installs the ScorBot 6-Axis Toolbox 
%   only if no copy of the ScorBot 6-Axis Toolbox exists in the MATLAB 
%   root.
%
